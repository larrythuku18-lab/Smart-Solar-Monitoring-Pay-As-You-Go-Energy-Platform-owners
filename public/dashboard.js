...
const createBatteryStateData = () => {
  ...
  const pointColors = data.map(value => value > 50 ? 'rgb(34, 197, 94)' : value > 20 ? 'rgb(245, 158, 11)' : 'rgb(239, 68, 68)');
  const pointBackground = pointColors;
  const background = data.map(value => value > 50 ? 'rgba(34, 197, 94, 0.24)' : value > 20 ? 'rgba(245, 158, 11, 0.24)' : 'rgba(239, 68, 68, 0.24)');
  return {
    labels,
    datasets: [{
      label: 'Battery Level (%)',
...
const createCreditDistributionData = () => {
  ...
  return {
    ...
    datasets: [{
      ...
      backgroundColor: ['rgb(239, 68, 68)', 'rgb(245, 158, 11)', 'rgb(245, 158, 11)', 'rgb(34, 197, 94)', 'rgb(34, 197, 94)'],
      borderRadius: 6,
      barPercentage: 0.7,
...
const createAgentPerformanceData = () => {
  ...
  const sorted = names.map((name, index) => ({
    name,
    value: amounts[index]
...
const SolarDashboard = () => {
  ...
  const refreshAllCharts = useCallback(() => {
    ...
    updateChart('par30', data => {
      data.datasets[0].data = newPar30.datasets[0].data;
    });
    ...
    updateChart('creditDistribution', data => {
      data.datasets[0].data = newCreditDistribution.datasets[0].data;
    });
  ...
  useEffect(() => {
    const actions = [Promise.resolve(createSolarGenerationData()), Promise.resolve(createBatteryStateData()), Promise.resolve(createGenerationVsConsumptionData()), Promise.resolve(createVoltageCurrentData()), Promise.resolve(createRevenueData()), Promise.resolve(createPaymentStatusData()), Promise.resolve(createPar30Data()), Promise.resolve(createCreditDistributionData()), Promise.resolve(createForecastData()), Promise.resolve(createAnomalyScoreData()), Promise.resolve(createFraudRiskData()), Promise.resolve(createCreditScoreTrendData()), Promise.resolve(createDeviceHealthData()), Promise.resolve(createAgentPerformanceData()), Promise.resolve(createMRRData()), Promise.resolve(createPanelEfficiencyData())];
  ...
  const creditLegend = creditScoreTrendData.current.datasets.map(ds => {
    const dot = ds.borderColor === 'rgb(34, 197, 94)' ? 'bg-emerald-500' : ds.borderColor === 'rgb(59, 130, 246)' ? 'bg-sky-500' : 'bg-rose-500';
    return /*#__PURE__*/React.createElement("div", {
      key: ds.label,
      className: "flex items-center gap-2 text-sm text-slate-600 dark:text-slate-300"
    }, /*#__PURE__*/React.createElement("span", {
      className: `w-2.5 h-2.5 rounded-full ${dot}`
    }), /*#__PURE__*/React.createElement("span", null, ds.label));
  });
  ...
  const growth = currentMRR && mrrData.current.values.length > 1 ? ((currentMRR - mrrData.current.values.at(-2)) / mrrData.current.values.at(-2) * 100).toFixed(1) : 0;
  ...
  }, subtitle)), /*#__PURE__*/React.createElement(Badge, {
    label: badge,
    color: badgeColor
  })), /*#__PURE__*/React.createElement("div", {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "min-h-screen bg-transparent text-slate-900 dark:text-slate-100 dashboard-shell"
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "Smart Solar Monitoring"), /*#__PURE__*/React.createElement("h1", {
    ...
    key: m.title,
    className: "rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-5 shadow-sm flex items-center justify-between gap-4"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", {
    ...
    footer: /*#__PURE__*/React.createElement(React.Fragment, null, "Peak today: ", /*#__PURE__*/React.createElement("span", {
      className: "font-semibold text-amber-600 dark:text-amber-400"
    }, peakToday, " kW"))
  }, /*#__PURE__*/React.createElement(Line, {
    ref: mkRef('solarGeneration'),
    data: solarGenerationData.current,
    options: baseOptions
  })), /*#__PURE__*/React.createElement(ChartCard, {
    ...
    footer: /*#__PURE__*/React.createElement(React.Fragment, null, "Current level: ", /*#__PURE__*/React.createElement("span", {
      className: "font-semibold text-amber-600 dark:text-amber-400"
    }, latestBattery, "%"))
  }, /*#__PURE__*/React.createElement(Line, {
    ref: mkRef('batteryState'),
    data: batteryStateData.current,
    options: {
      ...baseOptions,
      plugins: {
        ...baseOptions.plugins,
    ...
    footer: /*#__PURE__*/React.createElement(React.Fragment, null, "Surplus today: ", /*#__PURE__*/React.createElement("span", {
      className: "font-semibold text-emerald-600 dark:text-emerald-400"
    }, surplusToday, " kWh"))
  }, /*#__PURE__*/React.createElement(Bar, {
    ref: mkRef('generationVsConsumption'),
    data: generationVsConsumptionData.current,
    options: baseOptions
  })), /*#__PURE__*/React.createElement(ChartCard, {
    ...
    footer: /*#__PURE__*/React.createElement(React.Fragment, null, "Voltage: ", /*#__PURE__*/React.createElement("span", {
      className: "font-semibold"
    }, latestVoltage, " Vdc"), " \xB7 Current: ", /*#__PURE__*/React.createElement("span", {
      className: "font-semibold"
    }, latestCurrent, " A"))
  }, /*#__PURE__*/React.createElement(Line, {
    ref: mkRef('voltageCurrent'),
    data: voltageCurrentData.current,
    options: {
      ...baseOptions,
      scales: {
        x: {
  ...
  }))), activeTab === 'financial' && /*#__PURE__*/React.createElement("div", {
    className: "mt-6 grid grid-cols-1 gap-6 lg:grid-cols-2"
  }, /*#__PURE__*/React.createElement(ChartCard, {
    title: "Daily Revenue",
    badge: "14-Day",
    ...
    footer: /*#__PURE__*/React.createElement(React.Fragment, null, "Today: ", /*#__PURE__*/React.createElement("span", {
      className: "font-semibold text-emerald-600 dark:text-emerald-400"
    }, formatKES(todayRevenue)), " \xB7 MTD: ", /*#__PURE__*/React.createElement("span", {
      className: "font-semibold"
    }, formatKES(mtdRevenue)))
  }, /*#__PURE__*/React.createElement(Bar, {
    ref: mkRef('dailyRevenue'),
    ...
    options: {
      ...
      scales: {
        ...
        y: {
          ...baseOptions.scales.y,
          ticks: {
            callback: v => `KES ${Math.round(v / 1000)}k`,
            color: themeColors.text
          }
        }
      }
    ...
    footer: /*#__PURE__*/React.createElement(React.Fragment, null, "Current PAR30: ", /*#__PURE__*/React.createElement("span", {
      className: "font-semibold text-rose-600 dark:text-rose-400"
    }, currentPAR, "%"))
  }, /*#__PURE__*/React.createElement(Line, {
    ref: mkRef('par30'),
    data: par30Data.current,
    options: {
      ...baseOptions,
      plugins: {
        ...baseOptions.plugins,
    ...
    footer: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
      className: "font-semibold text-rose-600 dark:text-rose-400"
    }, lowCreditCount), " customers below 25% \u2014 send top-up alerts")
  }, /*#__PURE__*/React.createElement(Bar, {
    ref: mkRef('creditDistribution'),
    data: creditDistributionData.current,
    options: baseOptions
  })), /*#__PURE__*/React.createElement(ChartCard, {
    ...
    footer: /*#__PURE__*/React.createElement(React.Fragment, null, "MRR: ", /*#__PURE__*/React.createElement("span", {
      className: "font-semibold text-purple-600 dark:text-purple-400"
    }, formatKES(currentMRR)), " \xB7 Growth: ", /*#__PURE__*/React.createElement("span", {
      className: "font-semibold text-emerald-600 dark:text-emerald-400"
    }, "+", growth, "% MoM"))
  }, /*#__PURE__*/React.createElement(Line, {
    ref: mkRef('mrr'),
    data: mrrData.current,
    options: {
      ...baseOptions,
      scales: {
        x: {
    ...
    footer: /*#__PURE__*/React.createElement(React.Fragment, null, "Top: ", /*#__PURE__*/React.createElement("span", {
      className: "font-semibold"
    }, topAgent.name), " \xB7 ", formatKES(topAgent.value), " this month")
  }, /*#__PURE__*/React.createElement(Bar, {
    ref: mkRef('agentPerformance'),
    data: agentPerformanceData.current,
    options: {
      ...baseOptions,
      indexAxis: 'y',
      scales: {
    ...
    title: "6-Hour Energy Forecast",
    badge: "Forecast",
    badgeColor: "sky",
    subtitle: "AI-predicted generation with 90% confidence interval.",
    footer: /*#__PURE__*/React.createElement(React.Fragment, null, "Model accuracy: ", /*#__PURE__*/React.createElement("span", {
      className: "font-semibold text-sky-600 dark:text-sky-400"
    }, modelAccuracy, "%"), " \xB7 Next low at ", /*#__PURE__*/React.createElement("span", {
      className: "font-semibold"
    }, nextLow))
  }, /*#__PURE__*/React.createElement(Line, {
    ref: mkRef('energyForecast'),
    ...
    footer: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
      className: "font-semibold text-rose-600 dark:text-rose-400"
    }, anomaliesCount), " anomalies detected in the last 24 h")
  }, /*#__PURE__*/React.createElement(Bar, {
    ref: mkRef('anomalyScore'),
    data: anomalyScoreData.current,
    options: {
      ...baseOptions,
      plugins: {
        ...baseOptions.plugins,
    ...
    footer: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
      className: "font-semibold text-rose-600 dark:text-rose-400"
    }, flaggedCount), " transactions flagged by the Fraud Shield today")
  }, /*#__PURE__*/React.createElement(Scatter, {
    ref: mkRef('fraudRisk'),
    data: fraudRiskData.current,
    options: {
      ...baseOptions,
      plugins: {
        ...baseOptions.plugins,
    ...
    title: "Customer Credit Score Trend",
    badge: "Trend",
    badgeColor: "emerald",
    subtitle: "Three customer credit-score trajectories over 12 months."
  }, /*#__PURE__*/React.createElement(Line, {
    ref: mkRef('creditScoreTrend'),
    data: creditScoreTrendData.current,
    options: baseOptions
  }), /*#__PURE__*/React.createElement("div", {
    className: "mt-3 flex flex-wrap items-center justify-center gap-4"
  }, creditLegend))), activeTab === 'operations' && /*#__PURE__*/React.createElement("div", {
    className: "mt-6 grid grid-cols-1 gap-6 lg:grid-cols-2"
  }, /*#__PURE__*/React.createElement(ChartCard, {
    ...
    footer: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
      className: "font-semibold text-rose-600 dark:text-rose-400"
    }, deviceOffline), " devices offline \u2014 schedule field visits")
  }, /*#__PURE__*/React.createElement(Bar, {
    ref: mkRef('deviceHealth'),
    data: {
      labels: deviceHealthData.current.labels,
      datasets: deviceHealthData.current.datasets
    },
    options: {
      ...baseOptions,
      scales: {
    ...
    title: "Panel Efficiency vs Age",
    badge: "Field",
    badgeColor: "sky",
    subtitle: "Efficiency degradation scatter \u2014 panels below 75% need replacement.",
    footer: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
      className: "font-semibold text-rose-600 dark:text-rose-400"
    }, replaceCount), " panels flagged for replacement")
  }, /*#__PURE__*/React.createElement(Scatter, {
    ref: mkRef('panelEfficiency'),
    data: panelEfficiencyData.current,
    options: {
      ...baseOptions,
      scales: {
        x: {
